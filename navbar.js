function createNavBar(pathPrefix = '') {
    ...
    const navHtml = `
        <div class="nav-button-container">
            <button class="nav-button" onclick="window.location.href='${pathPrefix}games.html'">
            ...
            <button class="nav-button" onclick="window.location.href='${pathPrefix}movie-of-the-day.html'">
            ...
            <button class="nav-button" onclick="window.location.href='${pathPrefix}games/Chat.html'">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="nav-icon">
                    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>
                </svg>
            </button>
            <button class="nav-button" onclick="window.location.href='${pathPrefix}settings.html'">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="0" class="nav-icon">
            ...
            <button class="nav-button logout" onclick="window.location.href='${pathPrefix}index.html'">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="nav-icon">
